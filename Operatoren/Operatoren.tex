...
\subsection{Anordnung über-/untereinander}
\begin{LTXexample}[pos=l, rframe={}, width=.45]
\begin{center}
$ \underset{x}{yz} $\\
$ \overset{a}{bcd} $\\
...
\end{array}
\end{displaymath}
Um mathematische Ausdrücke mit der richtigen Klammergröße zu versehen, \quad $\backslash left$ \quad oder \quad $\backslash right$ \quad davor schreiben, z.B.: \quad $\backslash left($ \quad oder \quad$ \textcolor{red}{\backslash right \backslash \}}$.
